      ...
      <main className="implementation-page">
        ...
        <section className="implementation-hero">
          <div>
            ...
            <h1>Implementation requests</h1>

            <p>
              Track your software implementation requests and see what happens
              next.
            </p>
          </div>
        ...
        <section className="implementation-summary">
          ...
          <div>
            ...
            <p>
              Keep track of your active and completed implementation projects.
            </p>
          </div>
        </section>
        ...
        {requests.length === 0 && (
          <section className="implementation-empty">
            ...
            <h2>No implementation requests yet</h2>

            <p>
              Need help setting up your software? Submit an implementation
              request and we'll help connect you with a suitable partner.
            </p>
          ...
          <section className="implementation-list-section">
            <div className="implementation-section-head">
              <div>
                ...
                <h2>Your implementation activity</h2>
              </div>
            </div>

            <div className="implementation-list">
              {requests.map((request) => (
                <article className="implementation-card" key={request.id}>
                  {/* TOP */}
                  <div className="implementation-card-top">
                    <div className="implementation-software">
                      ...
                      <div>
                        <span className="implementation-label">SOFTWARE</span>
                  ...
                  <div className="implementation-progress">
                    ...
                    <div
                      className={
                        request.status === "Partner Matching"
                          ? "progress-line"
                  ...
                  <div className="implementation-card-footer">
                    <span>Request #{String(request.id).padStart(3, "0")}</span>

                    <button
                      type="button"
                      className="implementation-view-button"
                      onClick={() => navigate(`/implementation/${request.id}`)}
                    >
                      View request
                      <ArrowRight size={15} />
                    </button>
